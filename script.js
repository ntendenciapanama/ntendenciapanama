...
// Función simple para generar catálogo PDF
async function generarCatalogoPDF() {
    try {
        ...
        // Crear HTML simple del catálogo
        let html = `
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="header">
        ...
        <div class="date">Catálogo de Productos - ${new Date().toLocaleDateString('es-PA')}</div>
    </div>
`;
        ...
        productos.forEach(product => {
            html += `
    <div class="product">
        <img src="${product.imagen}" onerror="this.src='https://via.placeholder.com/250x250/410020/ffffff?text=IMG'" alt="${product.nombre}">
